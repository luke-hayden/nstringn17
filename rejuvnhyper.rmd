...
(p= ggplot(data=vardat2, aes(x=YvOl2fc, y=ROvOl2fc, label=sname, fill=rejuv, alpha=regencv))+
...
(p=ggplot(data=subset(md, md$rejuv != "other"), aes(x=snamer, y=normexp, colour=rejuv, fill=type))+
