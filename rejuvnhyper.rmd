...
vardat$rejuv[vardat$chosen== TRUE & vardat$regencv < cvthresh & vardat$ROvOl2fc/vardat$YvOl2fc > 0.8] <- "rejuvenated"
cvthresh<- 1

vardat$rejuv[vardat$chosen== TRUE & vardat$regencv < cvthresh & vardat$ROvOl2fc/vardat$YvOl2fc < -0.8] <- "aged"
...
vardat$rejuv[vardat$chosen== TRUE & vardat$regencv > cvthresh & vardat$ROvOl2fc/vardat$YvOl2fc < -0.0] <- "aged"
